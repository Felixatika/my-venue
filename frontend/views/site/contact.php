...
<div class="row">
    <div class="col-md-4">
    <div class="card intro" style="width: 100%; height: 30rem">
      <div class="card-body pt-5">
        <h5 class="card-title">Our Office</h5><br>
        <h6 class="card-subtitle mb-2 text-muted">Nairobi,<br>
        Kenya</h6><br>
        <p class="card-text">You can find us on the given location<br><br>
